              ...
              {options.map((option, index) => (
                <motion.div
                  ...
                  animate={{
                    y: 0,
                    opacity: 1,
                    transition: { type: "linear", delay: 0.4 + index * 0.1 },
                  }}
                  exit={{
                    y: -24,
                    opacity: 0,
      ...
      <div className="container flex justify-between">
        <div className="flex flex-column">
          ...
          <motion.div
            ...
            exit={{ y: 8, opacity: 0 }}
            transition={{ delay: 0.2, duration: 0.6, type: "linear" }}
            className="flex items-center gray60@text"
          >
            <Icon name="pin" height={16} width={16} strokeWidth={3} />{" "}
            <small className="ml1 gray70@text">Berlin, Germany</small>
          </motion.div>
        </div>
