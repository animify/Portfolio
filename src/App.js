  ...
  render() {
    return (
      <div className="container">
        <div className="main">
          <h1>
            Aspiring Product Designer, pixel lover, labrador owner. Currently
            engineering @ Overflow.
          </h1>
          <h3>
            I'm Stefan, a Software Engineer born in Thailand, raised in Asia,
            Sweden and Cyprus. With a passion for design &amp; detail, I strive
            on creating impactful solutions that matter.
          </h3>
        </div>
        <div className="info">
          <h2>Digital works</h2>
