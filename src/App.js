        ...
        return (
            <React.Fragment>
                <main className="container">
                    <div className="main">
                        <h1>Indie maker, coffee drinker, traveler, pixel admirer &amp; labrador owner.</h1>
                        <h3>
                            Currently getting up in the morning to engineer the future of user flows at Overflow. Always working on
                            designing &amp; building something new.
                        </h3>
                    </div>
                    <div className="content">
                        <div className="info">
                            <h2>Selected work</h2>
                            <h3>A few things I've made or worked on.</h3>
                        </div>
                        ...
                        <div className="info">
                            ...
                            <h3>Useful open source tools I've worked on.</h3>
                        </div>
                        <div className="projects">
                            <SideProject
                                date="May 2019"
                                header="useCopy"
                                desc="A React hook to copy dynamic textual data."
                            ...
                            <SideProject
                                date="Dec 2018"
                                header="useRestate"
                                desc="A React Hook that subscribes your state selector to the store."
                        ...
                        <a
                            className="button grey full"
                            target="_blank"
                            href="https://github.com/animify?tab=repositories"
