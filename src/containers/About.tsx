      ...
      <section className="about">
        <div className="container justify-between">
          <div className="short fadeInDown">
            ...
            <p>
              I'm a Swedish / Cypriot software maker with a keen passion for
              design &amp; development, now working remotely.
            </p>
            <p>
              Over the past few years, I graduated with a BSc in Computer
              Science from the University of Hull, interned at{" "}
              <a
              ...
              and engineered the worlds first user flow tool tailored for
              designers at{" "}
              <a
        ...
        <div className="container flex-column mt6 fadeInDown">
          <p>
            Apart from tinkering with my own projects daily and keeping up with
            the latest design &amp; software trends, I usually spend my free
            time driving to explore new places and travelling to countries I've
            never been to before. And of course as I'm staying on such a sunny
